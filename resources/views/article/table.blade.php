<div class="card card-custom gutter-b">
	<div class="card-header flex-wrap py-3">
		<div class="card-title">
			<h3 class="card-label">
				Articulos
				<span class="d-block text-muted pt-2 font-size-sm">Listado general de  de Articulos</span>
			</h3>
		</div>
		<div class="card-toolbar">
            <a href="{{route('article.create')}}" class="btn btn-success font-weight-bolder">
                                ...
                                <td>                                        
                                    {{Form::open(['route' => ['article.destroy', $article->id], 'method' => 'DELETE'])}}
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <a href="{{route('article.edit', $article->id) }}" class="btn btn-icon btn-outline-success btn-shadow font-weight-bold" data-toggle="tooltip" data-theme="dark" title="Editar Articulo">
